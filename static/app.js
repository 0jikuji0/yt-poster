    ...
    return '<div style="animation:dpop .3s ease;">' +
      '<header style="display:flex;align-items:flex-start;justify-content:space-between;gap:16px;margin-bottom:24px;flex-wrap:wrap;">' +
        ...
        '<div style="display:flex;gap:8px;flex:none;flex-wrap:wrap;">' +
          '<form method="post" action="' + aPath + '/post-now"><button class="hov-cta" style="border:1px solid #ff4d8d;background:#ff4d8d;color:#111;padding:9px 15px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;">▶ Poster maintenant</button></form>' +
